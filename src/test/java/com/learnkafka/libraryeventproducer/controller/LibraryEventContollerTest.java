...
import com.learnkafka.libraryeventproducer.controller.util.TestUtil;
...
//        when
        var responesEntity = testRestTemplate.exchange("/v1/libraryevent", HttpMethod.POST, httpEntity, LibraryEvent.class);

//        then
        assertEquals(HttpStatus.CREATED, responesEntity.getStatusCode());
